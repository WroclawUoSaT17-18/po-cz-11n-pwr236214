...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "bazaa.db";
    ...
    public DbHelper(Context context) {
        ...
        File file = new File(DB_PATH+"bazaa.db");
        if(file.exists())
            openDataBase();
    ...
    public List<Question> getQuestionMode(String mode) {
        ...
        Cursor c;
        int limit = 0;
        if (mode.equals(Common.MODE.Łatwy.toString()))
            limit = 30;
        else if (mode.equals(Common.MODE.Średni.toString()))
            limit = 50;
        else if (mode.equals(Common.MODE.Trudny.toString()))
            limit = 100;
        else if (mode.equals(Common.MODE.WiktorMode.toString()))
            limit = 200;
        try {
